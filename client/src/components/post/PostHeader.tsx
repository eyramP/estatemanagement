...
export default function PostHeader({ avatar, author_username, created_at, view_count }: PostHeaderProps) {
    ...
    <CardDescription className="mt-2">
        <div className="flex items-center space-x-2">
            ...
            <span className="text-xl-font-baby">
                ...
                {created_at ? formatDistanceToNow(parseISO(created_at), { addSuffix: true }) : "Loading..."}
            </span>
